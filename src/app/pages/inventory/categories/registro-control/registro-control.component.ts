...
export default class RegistroControlComponent implements OnInit {
  ...
  loadProducts() {
    ...
    this.productsService.searchByCategory(CategoriesDepartment.DEPARTAMENTO_REGISTRO_CONTROL).subscribe(resp => {
