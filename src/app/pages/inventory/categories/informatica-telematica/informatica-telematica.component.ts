...
@Component({
  selector: 'app-informatica-telematica',
  imports: [BreadcrumbsComponent, RouterLink],
  templateUrl: './informatica-telematica.component.html',
  styleUrl: './informatica-telematica.component.css'
})
export default class InformaticaTelematicaComponent implements OnInit {
  ...
  loadProducts() {
    ...
    this.productsService.searchByCategory(CategoriesDepartment.DEPARTAMENTO_INFORMATICA_TELEMATICA).subscribe(resp => {
