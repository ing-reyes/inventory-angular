...
export default class IngresoEgresoComponent implements OnInit {
  ...
  loadProducts() {
    ...
    this.productsService.searchByCategory(CategoriesDepartment.DEPARTAMENTO_INGRESO_EGRESO).subscribe(resp => {
