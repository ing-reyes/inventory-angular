...
export default class PlanificacionComponent implements OnInit {
  ...
  loadProducts() {
    ...
    this.productsService.searchByCategory(CategoriesDepartment.DEPARTAMENTO_PLANIFICACION).subscribe(resp => {
