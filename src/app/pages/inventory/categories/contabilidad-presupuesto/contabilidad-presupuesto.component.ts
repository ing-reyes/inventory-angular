...
@Component({
  ...
  templateUrl: './contabilidad-presupuesto.component.html',
  styleUrl: './contabilidad-presupuesto.component.css'
})
export default class ContabilidadPresupuestoComponent implements OnInit {
  ...
  loadProducts() {
    ...
    this.productsService.searchByCategory(CategoriesDepartment.DEPARTAMENTO_CONTABILIDAD_PRESUPUESTO).subscribe(resp => {
