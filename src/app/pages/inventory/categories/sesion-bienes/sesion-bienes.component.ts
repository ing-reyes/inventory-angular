...
@Component({
  selector: 'app-sesion-bienes',
  imports: [BreadcrumbsComponent, RouterLink],
  templateUrl: './sesion-bienes.component.html',
  styleUrl: './sesion-bienes.component.css'
})
export default class SesionBienesComponent implements OnInit {
  ...
  loadProducts() {
    ...
    this.productsService.searchByCategory(CategoriesDepartment.DEPARTAMENTO_SESION_BIENES).subscribe(resp => {
